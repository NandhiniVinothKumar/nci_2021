...
//console.log(`public key will ${sodium.crypto_sign_PUBLICKEYBYTES}-bytes long`);

//console.log(`secret key will ${sodium.crypto_sign_SECRETKEYBYTES}-bytes long`);
...
console.log(`signature verifies: ${bool}`);
